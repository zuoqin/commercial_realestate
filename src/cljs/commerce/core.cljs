...
(defonce app-state (atom {:savedanalogs {:0 [] :1 [] :2 []} :showcoeff true :state 0 :sort-list 1 :isloading false :selectedimage "r01-cian.ru/Snapshots/25.png" :object {:price0 0 :price1 0 :price2 0 :includedepr true :includenondepr true :koeff1 0 :koeff2 0 :koeff3 0 :koeff4 0 :koeff5 0 :koeff6 0 :koeff7 0 :koeff8 0 :koeff9 0 :koeff10 0 :koeff11 0 :koeff12 0 :koeff13 0 :koeff14 0 :koeff15 0 :koeff16 0 :approach 0 :hasshopwindows true :isbuildingliving true :houseline true :isentrance true :param ["id",  "RoomsNum", "Storey", "StoreysNum",  "RawAddress", "MicroDistrict", "RepairRaw","BuildingYear", "LivingSpaceArea", "KitchenArea", "SubwayTime"] :repair "стандарт" :analogs [] :foundation "" :project "" :data 0.0 :lat 55.751244 :lon 37.618423 :objecttype "Помещение" :leavingsquare 73.5 :kitchensquare 18.9 :totalsquare 40.7 :city "Москва" :assignment "псн" :analogscount 5 :buildingyear 2000 :ceilingheight 2.6 :storey 1 :storeysnum 9 :pricePerMetr 0.0 :metrodistance 15 :houseAvrgPrice 0.0 :regionAvrgPrice 0.0 :cityAvrgPrice 0.0}}))
